...
export const STORE_INCREMENT_COUNT_COMMENT_POST = 'STORE_INCREMENT_COUNT_COMMENT_POST'
...
export const storeIncrementCountCommentPost =value => createAction(STORE_INCREMENT_COUNT_COMMENT_POST)(value);
